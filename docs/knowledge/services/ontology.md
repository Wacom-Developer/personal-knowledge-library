...
`OntologyService(application_name: str = 'Ontology Service', service_url: str = 'https://private-knowledge.wacom.com', service_endpoint: str = 'ontology/v1', max_retries: int = 3, backoff_factor: float = 0.1)`
:   Ontology API Client
    -------------------
