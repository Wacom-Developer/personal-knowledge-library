Module knowledge.services.asyncio.queue_management
==================================================

Classes
-------

`AsyncQueueMonitorClient(service_url: str, application_name: str = 'Async Semantic Search ', base_auth_url: str | None = None, service_endpoint: str = 'vector/api/v1', verify_calls: bool = True, timeout: int = 60)`
